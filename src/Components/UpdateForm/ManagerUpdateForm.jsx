...
const ManagerUpdateForm = ({ managerData }) => {
  ...
  useEffect(() => {
    if (managerData) {
      ...
      setMiddleName(managerData.MiddleName);
      setLastName(managerData.LastName);
      setEmail(managerData.Email);
      setMobileNumber(managerData.MobileNumber);
      setGender(managerData.Gender);
      setLocation(managerData.Location);
    }
  }, [managerData]);

  const apiUpdateManager = async () => {
    try {
      const response = await axios({
        method: "PUT",
        url: "http://localhost:5000/v1/api/updatemanager",
        data: {
  ...
  const handleSubmit = async (e) => {
    ...
    toast
      .promise(
        apiUpdateManager(),
        {
          loading: "udpating Managers",
          success: "Manager udpated.",
          error: (error) => {
        ...
        <div className="flex flex-wrap mx-3 mb-6 justify-center items-center ">
          ...
          <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
              ...
              type="text"
              placeholder=""
              defaultValue={managerData?.MiddleName}
              onChange={(e) => {
        ...
        <div className="flex flex-wrap mx-3 mb-2">
          <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
              ...
              type="text"
              placeholder=""
              defaultValue={managerData.Location}
              onChange={(e) => {
